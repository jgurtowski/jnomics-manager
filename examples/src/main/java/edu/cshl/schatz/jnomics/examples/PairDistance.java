...
/**
 * @author James
 * Calculate the distance between aligned read pairs (paired end sequencing)
 * One approach for the detection of structural variations is the analysis
 * of discordant pairs. Insertions and deletions cause bridging reads to align
 * closer together or farther apart than the standard insert size.  
 * 
 * This example will list the distances between aligned pairs for the detection
 * of such anomalies. 
 * 
 */
public class PairDistance extends JnomicsTool {
   ...
   /**
    * @author James PairDistance Reducer 
    */
