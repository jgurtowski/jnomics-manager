 ...
 * Counts the number of sequencing reads that span a query template 
 * (refer to Samtools documentation for the definition of query template)
 * Jnomics is input file agnostic. It will pull the query template
 * from SAM, fastq etc. Note however, that "query template" may have a 
 * different meaning in each file context.
 */
public class HelloJnomics extends JnomicsTool {
   ...
   /**
    * @author James
	* Count the number of reads within a QueryTemplate
	* QueryTemplate refers to the Samtools definition of a query template
    */
