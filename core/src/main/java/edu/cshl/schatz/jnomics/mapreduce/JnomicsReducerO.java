...
import static edu.cshl.schatz.jnomics.mapreduce.JnomicsMapperO.COUNTER_GROUP;
 ...
 */
public class JnomicsReducerO<KEYIN, VALUEIN, KEYOUT, VALUEOUT>
        extends Reducer<KEYIN, VALUEIN, KEYOUT, VALUEOUT> {

    private static final Log LOG = LogFactory.getLog(JnomicsReducerO.class);
