...
public class Bowtie2 extends JnomicsTool{
    ...
    public static class Bowtie2Map extends Mapper<ReadCollectionWritable,NullWritable,Text,NullWritable>{
		...
		public void run(final Context context) throws IOException, InterruptedException {
            ...
            readerThread = new Thread(new ThreadedLineOperator(bowtieProcess.getInputStream(), new Operation(){
