...
public class JnomicsCompute {
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    private static class pairReads<I extends Iface> extends org.apache.thrift.ProcessFunction<I, pairReads_args> {
      public pairReads() {
        super("pairReads");
      }

      protected pairReads_args getEmptyArgsInstance() {
        return new pairReads_args();
      }

      protected pairReads_result getResult(I iface, pairReads_args args) throws org.apache.thrift.TException {
        pairReads_result result = new pairReads_result();
        try {
    ...
    private static class singleReads<I extends Iface> extends org.apache.thrift.ProcessFunction<I, singleReads_args> {
      public singleReads() {
        super("singleReads");
      }

      protected singleReads_args getEmptyArgsInstance() {
        return new singleReads_args();
      }

      protected singleReads_result getResult(I iface, singleReads_args args) throws org.apache.thrift.TException {
        singleReads_result result = new singleReads_result();
        try {
    ...
    private static class mergeVCF<I extends Iface> extends org.apache.thrift.ProcessFunction<I, mergeVCF_args> {
      public mergeVCF() {
        super("mergeVCF");
      }

      protected mergeVCF_args getEmptyArgsInstance() {
        return new mergeVCF_args();
      }

      protected mergeVCF_result getResult(I iface, mergeVCF_args args) throws org.apache.thrift.TException {
        mergeVCF_result result = new mergeVCF_result();
        try {
    ...
    private static class mergeCovariate<I extends Iface> extends org.apache.thrift.ProcessFunction<I, mergeCovariate_args> {
      public mergeCovariate() {
        super("mergeCovariate");
      }

      protected mergeCovariate_args getEmptyArgsInstance() {
        return new mergeCovariate_args();
      }

      protected mergeCovariate_result getResult(I iface, mergeCovariate_args args) throws org.apache.thrift.TException {
        mergeCovariate_result result = new mergeCovariate_result();
        try {
    ...
    private static class gatkRealign<I extends Iface> extends org.apache.thrift.ProcessFunction<I, gatkRealign_args> {
      public gatkRealign() {
        super("gatkRealign");
      }

      protected gatkRealign_args getEmptyArgsInstance() {
        return new gatkRealign_args();
      }

      protected gatkRealign_result getResult(I iface, gatkRealign_args args) throws org.apache.thrift.TException {
        gatkRealign_result result = new gatkRealign_result();
        try {
    ...
    private static class gatkCallVariants<I extends Iface> extends org.apache.thrift.ProcessFunction<I, gatkCallVariants_args> {
      public gatkCallVariants() {
        super("gatkCallVariants");
      }

      protected gatkCallVariants_args getEmptyArgsInstance() {
        return new gatkCallVariants_args();
      }

      protected gatkCallVariants_result getResult(I iface, gatkCallVariants_args args) throws org.apache.thrift.TException {
        gatkCallVariants_result result = new gatkCallVariants_result();
        try {
    ...
    private static class gatkCountCovariates<I extends Iface> extends org.apache.thrift.ProcessFunction<I, gatkCountCovariates_args> {
      public gatkCountCovariates() {
        super("gatkCountCovariates");
      }

      protected gatkCountCovariates_args getEmptyArgsInstance() {
        return new gatkCountCovariates_args();
      }

      protected gatkCountCovariates_result getResult(I iface, gatkCountCovariates_args args) throws org.apache.thrift.TException {
        gatkCountCovariates_result result = new gatkCountCovariates_result();
        try {
    ...
    private static class gatkRecalibrate<I extends Iface> extends org.apache.thrift.ProcessFunction<I, gatkRecalibrate_args> {
      public gatkRecalibrate() {
        super("gatkRecalibrate");
      }

      protected gatkRecalibrate_args getEmptyArgsInstance() {
        return new gatkRecalibrate_args();
      }

      protected gatkRecalibrate_result getResult(I iface, gatkRecalibrate_args args) throws org.apache.thrift.TException {
        gatkRecalibrate_result result = new gatkRecalibrate_result();
        try {
    ...
    private static class runSNPPipeline<I extends Iface> extends org.apache.thrift.ProcessFunction<I, runSNPPipeline_args> {
      public runSNPPipeline() {
        super("runSNPPipeline");
      }

      protected runSNPPipeline_args getEmptyArgsInstance() {
        return new runSNPPipeline_args();
      }

      protected runSNPPipeline_result getResult(I iface, runSNPPipeline_args args) throws org.apache.thrift.TException {
        runSNPPipeline_result result = new runSNPPipeline_result();
        try {
