...
public class JnomicsData {
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    private static class mkdir<I extends Iface> extends org.apache.thrift.ProcessFunction<I, mkdir_args> {
      public mkdir() {
        super("mkdir");
      }

      protected mkdir_args getEmptyArgsInstance() {
        return new mkdir_args();
      }

      protected mkdir_result getResult(I iface, mkdir_args args) throws org.apache.thrift.TException {
        mkdir_result result = new mkdir_result();
        try {
    ...
    private static class mv<I extends Iface> extends org.apache.thrift.ProcessFunction<I, mv_args> {
      public mv() {
        super("mv");
      }

      protected mv_args getEmptyArgsInstance() {
        return new mv_args();
      }

      protected mv_result getResult(I iface, mv_args args) throws org.apache.thrift.TException {
        mv_result result = new mv_result();
        try {
    ...
    private static class listGenomes<I extends Iface> extends org.apache.thrift.ProcessFunction<I, listGenomes_args> {
      public listGenomes() {
        super("listGenomes");
      }

      protected listGenomes_args getEmptyArgsInstance() {
        return new listGenomes_args();
      }

      protected listGenomes_result getResult(I iface, listGenomes_args args) throws org.apache.thrift.TException {
        listGenomes_result result = new listGenomes_result();
        try {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<JnomicsThriftFileStatus>(_list8.size);
                  for (int _i9 = 0; _i9 < _list8.size; ++_i9)
                  {
                    JnomicsThriftFileStatus _elem10; // required
                    _elem10 = new JnomicsThriftFileStatus();
                    _elem10.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, listStatus_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (JnomicsThriftFileStatus _iter11 : struct.success)
            {
              _iter11.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (JnomicsThriftFileStatus _iter12 : struct.success)
            {
              _iter12.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<JnomicsThriftFileStatus>(_list13.size);
            for (int _i14 = 0; _i14 < _list13.size; ++_i14)
            {
              JnomicsThriftFileStatus _elem15; // required
              _elem15 = new JnomicsThriftFileStatus();
              _elem15.read(iprot);
