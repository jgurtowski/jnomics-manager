...
public class PairedEndLoader implements ManagerTask {
     ...
     * @throws Exception
     */
    public static void load(File file1, File file2, Path hdfsOut, String namenode) throws Exception {
    ...
    public static void load(File file1, File file2, Path hdfsOut) throws Exception {
        load(file1,file2,hdfsOut,null);
    }
